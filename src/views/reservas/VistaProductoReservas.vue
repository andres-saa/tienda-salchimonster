...
>
  ...
  <!-- <div class="header-container">
    <h3>{{ store.currentProduct.productogeneral_descripcion }}</h3>
    <h3>
      {{
...
import CartReservas from './CartReservas.vue';
...
onMounted(() => {
      ...
      const the_product = store.menu.data.find(
        (p) => p.productogeneral_id == "138"
      );
      store.currentProduct = the_product

      store.addProductToCart(the_product,1,[]);
