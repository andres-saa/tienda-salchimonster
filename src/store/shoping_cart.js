...
export const usecartStore = defineStore('salchimonster-cart', {
  persist: {
    key: 'salchimonster-cart',
  ...
  actions: {
    ...
    //   console.log('hi', product)
      ...
      const cartProduct = this.cart.products.find((p) => this.getProductId(p.product) === productId)
      ...
      if (cartProduct) {
        ...
        this.cart.products.push({
          ...
          total_cost: this.calculateProductTotal(productWithId, quantity, additionalItems),
        })
      }
      this.calculateCartTotal()
    },
    ...
    removeProductInstance(productId) {
      ...
      if (cartProduct && cartProduct.quantity > 1) {
        ...
        cartProduct.total_cost -=
          cartProduct.product.productogeneral_precio ||
          cartProduct.product.lista_presentacion[0].producto_precio
        this.calculateCartTotal()
    ...
    calculateCartTotal() {
      const productsTotal = this.cart.products.reduce(
